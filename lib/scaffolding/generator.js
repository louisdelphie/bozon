...
class Generator {
  ...
  generate() {
    ...
    questioner.prompt(function (answers) {
      ...
      self.defaults.year = year
      self.defaults.month = month
      self.setup()
    })
  }
  ...
  createDirectories() {
    ...
    this.mkdir(this.name, 'app', 'assets')
    this.mkdir(this.name, 'app', 'assets', 'images')
    this.mkdir(this.name, 'app', 'assets', 'stylesheets')
    this.mkdir(this.name, 'app', 'src')
    this.mkdir(this.name, 'app', 'src', 'javascripts')
    this.mkdir(this.name, 'app', 'src', 'javascripts', 'main')
    this.mkdir(this.name, 'app', 'src', 'javascripts', 'renderer')
  ...
  copyTemplates() {
    ...
    this.copyTpl('index.html', $('app', 'src', 'index.html'))
    this.copyTpl($('json', 'production_package.json'), $('app', 'package.json'), this.defaults)
    this.copyTpl($('stylesheets', 'application.css'), $('app', 'assets', 'stylesheets', 'application.css'))
    this.copyTpl($('javascripts', 'main.js'), $('app', 'src', 'javascripts', 'main', 'main.js'))
    this.copyTpl($('javascripts', 'application.js'), $('app', 'src', 'javascripts', 'renderer', 'application.js'))
